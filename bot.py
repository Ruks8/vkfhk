...
TOKEN = '8109434945:AAEYJEuPdkhtulPPqKJTvGSpYsLoQ_JwOEs' #توكنك 
ADMIN_ID ='7210443763'  # ايديك
channel = ' @ndmmo' #يوزر قناتك هنا مو الرابط
# ممنوع تغيير المصدر @YYY1MM
...
def send_welcome(message):
    ...
    dev_channel_button = types.InlineKeyboardButton('🔧 قناة المطور', url='https://t.me/ndmmo')
...
# لا تغير الحقوق يا فاشل زلم تعبت بيها @YYY1MM
